...
One of my summer goals was exploring some new data science technologies.  That wouldn't be complete without looking at some tools for deploying some machine learnign models to production.  A few years ago, I had the experience of running my models on an EC2 instances, which was not an ideal experience.  So I took a look at AWS Sagemaker, which allows you to build and deploy machine learning models and they also have some good [documentation](https://docs.aws.amazon.com/sagemaker/latest/dg/whatis.html) filled with examples.
